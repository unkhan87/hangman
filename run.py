...
def welcome_msg():
    ...
    view_instructions = input('Please type 1 to see the instructions'
                              ' or 2 to start the the game!:\n')
...
def instructions():
    ...
    """
    print(
        'Instructions:\n\n To play hangman you will need to guess your'
        'word letter by letter.\n\n1. Start guessing'
        'the letter and hit enter.\n2. If your letter is correct one of'
        'the blank space will get populated.\n3.'
        ' If you gussed an incorrect letter you will get a strike and a section'
        'of a hangman will appear.\n4. You have got'
...
def play_again():
    ...
    while play_again_option != "1" and play_again_option != "2":
        play_again_option = input("Invalid Input!\n"
                                  "Please press 1 to play again and"
